...
>>>>>>> df439cfc39524673f113184fe0d1c12e2e35b77d
...
const validatedFields = validateBody(profileSchema, rawData);
...
export const createPropertyAction = async (
  ...
  try {
    ...
    const validatedFields = validateBody(propertySchema, rawData);
    const validatedFile = validateBody(imageSchema, { image: file });
